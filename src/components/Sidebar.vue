  ...
  >
    <div class="flex items-center h-16 border-b border-border/80" :class="store.sidebarCollapsed ? 'justify-center px-2' : 'px-4'">
      <div class="flex items-center gap-2 min-w-0">
        <span class="flex h-8 w-8 items-center justify-center rounded-xl bg-white shadow-sm ring-1 ring-border/60">
          <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 48 46" aria-label="Logo"><defs><linearGradient id="sidebar-logo-grad" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#a855f7"/><stop offset="1" stop-color="#7e14ff"/></linearGradient></defs><path d="M25.946 44.938c-.664.845-2.021.375-2.021-.698V33.937a2.26 2.26 0 0 0-2.262-2.262H10.287c-.92 0-1.456-1.04-.92-1.788l7.48-10.471c1.07-1.497 0-3.578-1.842-3.578H1.237c-.92 0-1.456-1.04-.92-1.788L10.013.474c.214-.297.556-.474.92-.474h28.894c.92 0 1.456 1.04.92 1.788l-7.48 10.471c-1.07 1.498 0 3.579 1.842 3.579h11.377c.943 0 1.473 1.088.89 1.83L25.947 44.94z" fill="url(#sidebar-logo-grad)"/></svg>
        </span>
