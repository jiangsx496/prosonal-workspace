...
export interface ImportRecord {
  ...
  mimeType: string
  size: number
  content: string          // 提取的文本内容（图片为 base64，docx/pdf 为空）
...
export const useImportStore = defineStore('imports', () => {
  ...
  return { records, pending, parsed, imported, generateId, addRecord, updateStatus, removeRecord, getContent, detectType }
})
